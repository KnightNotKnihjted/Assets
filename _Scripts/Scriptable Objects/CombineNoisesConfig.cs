...
[CreateAssetMenu(fileName ="New CombineNoisesConfig",menuName ="Scriptables/CombineNoisesConfig")]
public class CombineNoisesConfig : NoiseConfigBase
{
    ...
    {
        return Mathf.Min(noise1.GetNoiseValue(x, y, seed), noise2.GetNoiseValue(x, y, seed));
    }
}